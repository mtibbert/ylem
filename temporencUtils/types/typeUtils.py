...
class TypeUtils:
    ...
    # Depreciated
    # TODO: TemporencUtils Function Names Should be Lowercase #7
    @staticmethod
    def isValidPrecisionName(precision):
        """
        ***
        *** Depreciated use TypeUtils.is_valid_precision_name(precision)
        ***
        Validates that a string is a sub second precision name in the
        dictionary: millisecond, microsecond, nanosecond, and none. Validation
        is case-sensative so 'none' will return True; while 'NONE', 'None', and
        ...
        return TypeUtils.is_valid_precision_name(precision)

    @staticmethod
    def isValidTypeName(type_name):
        """
        ***
        *** Depreciated use TypeUtils.is_valid_type_name(type_name)
        ***
        Validates that a string is a sub second _type_name name in the
        dictionary: D, T, DT, DTZ, DTS, and DTSZ. Validation
        is case-sensative so 'none' will return True; while 'NONE', 'None', and
        ...
        # TODO TemporencUtils Function Names Should be Lowercase #7
        warnings.warn("deprecated", DeprecationWarning)
        return TypeUtils.is_valid_type_name(type_name)
